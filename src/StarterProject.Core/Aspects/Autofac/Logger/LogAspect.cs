...
using StarterProject.Core.CrossCuttingConcerns.Logging;
using StarterProject.Core.CrossCuttingConcerns.Logging.Serilog;
...
namespace StarterProject.Core.Aspects.Autofac.Logger
{
